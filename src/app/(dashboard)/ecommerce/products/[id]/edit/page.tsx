...
const mockProducts: Record<string, {
  ...
  "1": { name: "SCW Snow Foam", type: "simple", status: "published", sku: "SCW-SF-001", stock: "245", manageStock: true, regularPrice: "85000", salePrice: "", category: "Exterior", description: "Snow foam berkualitas tinggi untuk pencucian eksterior kendaraan. Menghasilkan busa tebal yang efektif mengangkat kotoran tanpa goresan." },
  "2": { name: "SCW Ceramic Coating 9H", type: "simple", status: "published", sku: "SCW-CC-002", stock: "12", manageStock: true, regularPrice: "450000", salePrice: "399000", category: "Coating", description: "Coating keramik 9H dengan ketahanan hingga 2 tahun. Melindungi cat kendaraan dari UV, goresan, dan kontaminasi." },
  "3": { name: "SCW Interior Detailer", type: "simple", status: "published", sku: "SCW-ID-003", stock: "180", manageStock: true, regularPrice: "75000", salePrice: "", category: "Interior", description: "Detailer interior serbaguna untuk membersihkan dan melindungi dashboard, panel pintu, dan trim interior." },
  "4": { name: "SCW Tire Gel Pro", type: "simple", status: "published", sku: "SCW-TG-004", stock: "95", manageStock: true, regularPrice: "65000", salePrice: "", category: "Exterior", description: "Gel pelindung ban dengan efek basah yang tahan lama. Memberikan kilau hitam sempurna pada ban." },
}
...
export default function EditProductPage() {
  ...
  const [manageStock, setManageStock] = useState(product.manageStock)
