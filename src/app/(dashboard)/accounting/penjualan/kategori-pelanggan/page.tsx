...
const dummyData: Kategori[] = [
  { id: "1", nama: "General", default: true },
  { id: "2", nama: "VIP", default: false },
  { id: "3", nama: "Reseller", default: false },
]
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        <div>
          <h1 style={{ fontSize: 20, fontWeight: 700, color: "#001526" }}>Kategori Pelanggan</h1>
          <p style={{ fontSize: 13, color: "#444746", marginTop: 2 }}>Kelola kategori dan golongan pelanggan</p>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 10, paddingBottom: 12 }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <input type="text" placeholder="Cari kategori pelanggan..." value={search} onChange={(e) => setSearch(e.target.value)} style={{ height: 32, padding: "0 10px 0 30px", fontSize: 13, border: "1px solid #d8d8d8", borderRadius: 6, width: 200, outline: "none" }} />
          </div>
      ...
      <div style={{ flex: 1, overflow: "auto", background: "#fff" }}>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead><tr style={{ background: "#fff" }}>
            ...
            <th style={{ ...thStyle, width: "50%" }}>Nama Kategori</th>
            <th style={{ ...thStyle, width: "45%" }}>Kategori Default</th>
          </tr></thead>
          <tbody>
            {filtered.map(item => (
