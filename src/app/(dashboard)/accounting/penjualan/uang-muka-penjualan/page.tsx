    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        <div>
          ...
          <p style={{ fontSize: 13, color: "#444746", marginTop: 2 }}>Kelola uang muka dari pelanggan</p>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 10, paddingBottom: 12, flexWrap: "wrap" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <input type="text" placeholder="Cari uang muka..." value={search} onChange={(e) => setSearch(e.target.value)} style={{ height: 32, padding: "0 10px 0 30px", fontSize: 13, border: "1px solid #d8d8d8", borderRadius: 6, width: 200, outline: "none" }} />
          </div>
          <button
      ...
      <BuatBaruModal
        ...
        title="Buat Uang Muka Penjualan"
        subtitle="Uang muka dari pelanggan sebelum faktur terbit"
        fields={[
          ...
          <tbody>
            {filtered.length === 0 ? (
              ...
              >
                ...
                <td style={{ ...tdStyle, fontWeight: 500 }}>{item.keterangan}</td>
