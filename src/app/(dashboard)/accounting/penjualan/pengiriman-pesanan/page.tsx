...
import { dummyDeliveryOrders, type DeliveryOrder, dummyCustomers, dummyProducts } from "@/lib/accounting-dummy-data"
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <BuatBaruModal
        ...
        title="Buat Pengiriman Pesanan"
        subtitle="Buat surat jalan pengiriman pesanan"
        fields={[
          { key: "pelanggan", label: "Send to", type: "combobox", options: CUSTOMER_OPTIONS, required: true, placeholder: "Cari/Pilih Pelanggan..." },
          { key: "tanggal", label: "Date", type: "date", defaultValue: "2026-07-06", required: true },
          { key: "pengiriman", label: "Shipment", type: "select", options: [{ value: "JNE", label: "JNE" }, { value: "J&T", label: "J&T" }, { value: "SiCepat", label: "SiCepat" }, { value: "Pickup", label: "Ambil Sendiri" }], defaultValue: "JNE" },
        ]}
        itemFields={[
