  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        <div><h1 style={{ fontSize: 20, fontWeight: 700, color: "#001526" }}>Penerimaan Penjualan</h1><p style={{ fontSize: 13, color: "#444746", marginTop: 2 }}>Catat penerimaan pembayaran dari pelanggan</p></div>
      ...
      <div style={{ flex: 1, overflow: "auto", background: "#fff" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          <thead><tr style={{ background: "#4a5568" }}>
            {[{l:"",w:"30px"},{l:"Nomor #",w:"9%"},{l:"Tanggal",w:"8%"},{l:"No. Cek",w:"8%"},{l:"Tanggal Cek",w:"8%"},{l:"Pelanggan",w:"16%"},{l:"Bank",w:"10%"},{l:"Keterangan",w:"18%"},{l:"Pakai Kredit",w:"8%"},{l:"Nilai Pembayaran",w:"10%",a:"right"}].map((c:any) => <th key={c.l||"x"} style={{ padding: "6px 8px", textAlign: c.a||"left", fontWeight: 600, color: "#fff", borderBottom: "1px solid #3a4150", width: c.w, fontSize: 10 }}>{c.l}</th>)}
          </tr></thead>
          <tbody><tr><td colSpan={10} style={{ padding: 60, textAlign: "center", color: "#888" }}>Belum ada data</td></tr></tbody>
        </table>
      </div>
    </div>
  )
