  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        <div><h1 style={{ fontSize: 20, fontWeight: 700, color: "#001526" }}>Faktur Penjualan</h1><p style={{ fontSize: 13, color: "#444746", marginTop: 2 }}>Buat dan kelola faktur/invoice penjualan</p></div>
      ...
      <div style={{ flex: 1, overflow: "auto", background: "#fff" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          <thead><tr style={{ background: "#4a5568" }}>
            {[{l:"Nomor #",w:"11%"},{l:"Tanggal",w:"9%"},{l:"Pelanggan",w:"18%"},{l:"Keterangan",w:"18%"},{l:"Status",w:"10%"},{l:"Tipe ID Wajib",w:"11%"},{l:"Umur (hr)",w:"8%"},{l:"Total",w:"12%",a:"right"}].map((c:any) => <th key={c.l} style={{ padding: "8px 10px", textAlign: c.a||"left", fontWeight: 600, color: "#fff", borderBottom: "1px solid #3a4150", width: c.w, fontSize: 11 }}>{c.l}</th>)}
          </tr></thead>
