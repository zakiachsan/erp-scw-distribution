  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        <h1 style={{ fontSize: 20, fontWeight: 700, color: "#001526" }}>Pembayaran</h1>
        <p style={{ fontSize: 13, color: "#444746", marginTop: 2 }}>Catat dan kelola pembayaran keluar</p>
          ...
          <tbody>
            {filtered.length === 0 ? (
              ...
              <tr key={item.id} style={{ cursor: "pointer" }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.background = "#f0f7ff"} onMouseLeave={e => (e.currentTarget as HTMLElement).style.background = "transparent"}>
                ...
                <td style={{ ...TD, textAlign: "right", fontFamily: "monospace", color: "#ea001e" }}>{formatIDR(item.nilai)}</td>
              </tr>
            ))}
          </tbody>
        </table>
