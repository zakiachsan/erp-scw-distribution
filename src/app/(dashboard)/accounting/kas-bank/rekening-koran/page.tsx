  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        <div><h1 style={{ fontSize: 20, fontWeight: 700, color: "#001526" }}>Rekening Koran</h1><p style={{ fontSize: 13, color: "#444746", marginTop: 2 }}>Rekonsiliasi rekening koran bank</p></div>
      ...
      <div style={{ flex: 1, overflow: "auto", background: "#fff" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
          <thead><tr style={{ background: "#4a5568" }}>
            {[{l:"Tanggal",w:"12%"},{l:"Keterangan",w:"30%"},{l:"Mutasi",w:"14%",a:"right"},{l:"Tipe",w:"10%"},{l:"Saldo",w:"14%",a:"right"},{l:"#",w:"5%"}].map((c:any) => <th key={c.l} style={{ padding: "8px 12px", textAlign: c.a||"left", fontWeight: 600, color: "#fff", borderBottom: "1px solid #3a4150", width: c.w }}>{c.l}</th>)}
          </tr></thead>
