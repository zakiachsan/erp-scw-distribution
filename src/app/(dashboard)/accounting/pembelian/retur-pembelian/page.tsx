  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        ...
        subtitle="Retur barang ke pemasok"
        fields={[
          { key: "pemasok", label: "Pemasok", type: "combobox", options: SUPPLIER_OPTIONS, required: true, placeholder: "Cari/Pilih Pemasok..." },
          { key: "returnNo", label: "Return No", type: "text", placeholder: "Otomatis" },
          { key: "tanggal", label: "Tanggal", type: "date", defaultValue: "2026-07-07", required: true },
          { key: "returnFrom", label: "Return From", type: "select", options: [{ value: "Faktur", label: "Faktur" }, { value: "Item", label: "Item" }], defaultValue: "Faktur" },
        ]}
        itemFields={[
