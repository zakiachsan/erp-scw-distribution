  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "12px 20px 0", background: "#fff" }}>
        ...
        subtitle="Catat penerimaan barang dari pemasok"
        fields={[
          ...
          { key: "noTerima", label: "No Terima", type: "text", placeholder: "No. penerimaan..." },
          { key: "keterangan", label: "Keterangan", type: "textarea", placeholder: "Catatan penerimaan..." },
        ]}
        itemFields={[
