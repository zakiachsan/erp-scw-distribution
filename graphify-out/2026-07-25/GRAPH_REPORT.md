# Graph Report - erp-scw-distribution  (2026-07-25)

## Corpus Check
- 258 files · ~307,180 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2172 nodes · 4918 edges · 159 communities (137 shown, 22 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65b0e357`
...
4. `Badge()` - 100 edges
5. `Button()` - 98 edges
6. `CardHeader()` - 98 edges
7. `CardTitle()` - 98 edges
8. `Table()` - 83 edges
...
Cohesion: 0.05
Nodes (65): bankOptions, mockTransfers, Transfer, conditionConfig, defaultReturn, mockReturns, resolutionConfig, ReturnDetail (+57 more)

### Community 1 - "CardDescription"
Cohesion: 0.04
Nodes (66): budgetData, BudgetItem, divisions, categoryFilterOptions, formatDate(), statusBadge(), WorkOrder, workOrders (+58 more)

### Community 2 - "table.tsx"
Cohesion: 0.06
Nodes (54): journalEntries, JournalEntry, transactionTypes, cashBankOptions, mockReceipts, ReceiptItem, bankOptions, mockReconciliations (+46 more)

### Community 3 - "cn"
Cohesion: 0.05
Nodes (57): SettingsLayout(), settingsNav, Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage() (+49 more)

### Community 4 - "label.tsx"
Cohesion: 0.06
Nodes (46): productCatalog, ProductEntry, SelectedRack, notifications, priorityConfig, typeIcons, CustomerListPage(), formatIDR() (+38 more)

### Community 5 - "pembayaran-pembelian/page.tsx"
Cohesion: 0.05
Nodes (41): BTN_ICON, BTN_ICON_OUTLINE, formatIDR(), INPUT, PembayaranPage(), SELECT, TD, TH (+33 more)

### Community 6 - "inventory/[id]/page.tsx"
Cohesion: 0.05
Nodes (38): DamagedItemsPage(), DamagedDetailPage(), defaultCategories, defaultProduct, formatIDR(), formatUSD(), movementTypeConfig(), Product (+30 more)

### Community 7 - "accounting-dummy-data.ts"
Cohesion: 0.06
Nodes (30): AccountingDashboardPage(), formatIDR(), Tab, defaultKurs, KursMataUang, Contact, dummyAccounts, dummyContacts (+22 more)

### Community 8 - "tiering/page.tsx"
Cohesion: 0.08
Nodes (33): defaultProduct, discussionsData, formatPrice(), productData, ProductDetailPage(), relatedProducts, reviewsData, materials (+25 more)

### Community 9 - "histori-akun/page.tsx"
Cohesion: 0.06
Nodes (25): btnIconBlue, btnIconWhite, inputStyle, thStyle, BTN_ICON, BTN_ICON_OUTLINE, formatIDR(), HistoriBankPage() (+17 more)
...
Cohesion: 0.10
Nodes (22): CartItem, CartPage(), formatPrice(), initialCartItems, allProducts, categories, formatPrice(), priceRanges (+14 more)

### Community 13 - "badge.tsx"
Cohesion: 0.10
Nodes (20): accounts, formatIDR(), ledgerData, LedgerEntry, LedgerPage(), typeBadge(), initialReviews, Review (+12 more)

### Community 14 - "jurnal-umum/page.tsx"
Cohesion: 0.08
Nodes (10): btnIconBlue, btnIconWhite, inputStyle, labelStyle, selectStyle, thStyle, btnIconWhite, inputStyle (+2 more)

### Community 15 - "coupons/page.tsx"
Cohesion: 0.15
Nodes (18): Banner, initialBanners, Category, initialCategories, Coupon, CouponsPage(), formatRupiah(), initialCoupons (+10 more)

### Community 16 - "pesanan-penjualan/page.tsx"
Cohesion: 0.08
Nodes (21): btnIcon, btnIconOutline, formatIDR(), inputStyle, labelStyle, PesananPenjualanPage(), rowStyle, selectStyle (+13 more)
...
Cohesion: 0.09
Nodes (10): btnIcon, btnIconBlue, btnIconWhite, btnPrimary, FormTab, inputStyle, labelStyle, selectStyle (+2 more)
...
Cohesion: 0.13
Nodes (13): CreateReturnForm(), formatIDR(), reasons, ReturnItem, SalesOrder, salesOrders, SOItem, categories (+5 more)

### Community 22 - "dependencies"
Cohesion: 0.11
Nodes (19): @base-ui/react, class-variance-authority, clsx, cmdk, lucide-react, dependencies, @base-ui/react, class-variance-authority (+11 more)
...
Cohesion: 0.14
Nodes (12): PackingVideo, videos, getInitialData(), LogisticDetailPage(), LogisticItem, nextStatus, PaymentRecord, saveData() (+4 more)
...
Cohesion: 0.23
Nodes (12): colorMap, iconMap, ModulesPage(), iconMap, Sidebar(), getModuleById(), getModuleIdByPathname(), ModuleId (+4 more)
...
Cohesion: 0.14
Nodes (8): AdjustmentItem, btnIcon, btnIconBlue, btnIconWhite, btnPrimary, inputStyle, labelStyle, thStyle
...
Cohesion: 0.21
Nodes (11): LanguageSwitcher(), options, breadcrumbs, chrome, Lang, LangState, menuLabels, moduleDescs (+3 more)
...
Cohesion: 0.21
Nodes (11): calculateShipping(), EstimasiHargaPage(), formatRupiah(), LineItem, nextLineId(), Product, products, TIER_DISCOUNT (+3 more)
...
Cohesion: 0.24
Nodes (10): fmt(), initialData, parseNum(), QuotationDetail, QuotationDetailPage(), recalcVendor(), satuanList, statusVariant (+2 more)
...
Cohesion: 0.20
Nodes (9): CreateQuotationForm(), customers, CustomerType, customerTypeDiscount, deliveryOptions, formatIDR(), productCategories, products (+1 more)

### Community 82 - "checkout/page.tsx"
Cohesion: 0.27
Nodes (8): checkoutItems, CheckoutPage(), formatPrice(), paymentMethods, savedAddresses, shippingMethods, RadioGroup(), RadioGroupItem()
...
Cohesion: 0.20
Nodes (8): BTN_ICON, BTN_ICON_OUTLINE, dummyData, INPUT, SELECT, SmartlinkEBanking, TD, TH
...
Cohesion: 0.22
Nodes (9): formatIDR(), LaporanPenjualanPage(), monthlyData, periods, tdStyle, thStyle, topProducts, totalOrder (+1 more)
...
Cohesion: 0.24
Nodes (9): formatCurrency(), formatIDR(), POTransaction, poTransactions, statusConfig, Supplier, SupplierDetailPage(), supplierPOMap (+1 more)

### Community 91 - "(dashboard)/sales/invoices/create/page.tsx"
Cohesion: 0.22
Nodes (9): CreateInvoicePage(), formatIDR(), invoiceableStatuses, PO, POItem, products, purchaseOrders, statusConfig (+1 more)
...
Cohesion: 0.22
Nodes (7): CURRENCIES, Currency, CURRENCY_FLAGS, CURRENCY_SYMBOLS, CurrencyRate, initialRates, rateHistory

### Community 97 - "orders/create/page.tsx"
Cohesion: 0.22
Nodes (6): customers, OrderItem, PIPELINE_DEALS, PIPELINE_QUOTATION_ITEMS, products, tierDiscountMap
...
Cohesion: 0.29
Nodes (7): getSupplierStats(), POTransaction, poTransactions, Supplier, supplierPOMap, suppliers, SuppliersPage()

### Community 107 - "react"
Cohesion: 0.29
Nodes (7): react, react, CustomerReturnDetailPage(), formatIDR(), formatIDR(), SalesOrderDetailPage(), SearchableSelect()
...
Cohesion: 0.38
Nodes (6): FilterValue, formatIDR(), Payment, payments, PaymentsPage(), statusBadge()
...
Cohesion: 0.38
Nodes (6): formatRupiah(), Product, products, ProductsPage(), statusConfig, stockStatus()
...
Cohesion: 0.33
Nodes (6): commissionHistory, dealsData, formatIDR(), members, SalesTeamDetailPage(), SalesTeamMember
...
Cohesion: 0.50
Nodes (4): formatDate(), formatIDR(), ReceiptsPage(), statusBadge()
...
Cohesion: 0.50
Nodes (4): formatDate(), formatIDR(), statusBadge(), TransfersPage()

## Knowledge Gaps
- **1133 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+1128 more)
...
- **Why does `cn()` connect `cn` to `card.tsx`, `CardDescription`, `table.tsx`, `modules/page.tsx`, `label.tsx`, `tiering/page.tsx`, `react`, `roles/page.tsx`, `badge.tsx`, `coupons/page.tsx`, `i18n.ts`, `checkout/page.tsx`, `customer-returns/create/page.tsx`, `input.tsx`, `navbar.tsx`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `cn`, `modules/page.tsx`, `tiering/page.tsx`, `i18n.ts`, `dependencies`, `input.tsx`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `react`, `date-fns`, `next`, `@prisma/client`, `react-day-picker`, `react-dom`, `tailwind-merge`, `zustand`, `package.json`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
